...
<Note>
  The Services Platform handles all third-party integrations and external API communications for the Roomi ecosystem with unified interfaces.
</Note>

## Overview

The Services Platform provides a unified interface for property developer and user-specific services, including events, complaints, payments, facilities booking, routines, and email services. It abstracts away the complexity of different third-party APIs and provides consistent data models.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Property Developer APIs"
    href="#property-developer-apis"
    icon="building"
  >
...
```bash
# Production
https://services-prod-ae.roomi-services.com/v1/

# Staging
https://services-staging-ae.roomi-services.com/v1/

# Development
https://services-dev-ae.roomi-services.com/v1/
```
...
const request = {
  method: "GET",
  hostname: "services-prod-ae.roomi-services.com",
  path: "/v1/health",
  headers: {
...
<Table>
  <Table.Head>
    <Table.Row>
      ...
      <Table.Header>Features</Table.Header>
    </Table.Row>
  </Table.Head>
  <Table.Body>
    <Table.Row>
      <Table.Cell><Badge variant="blue">Events</Badge></Table.Cell>
      <Table.Cell>Community events and social activities</Table.Cell>
      <Table.Cell>Event creation, RSVP, notifications</Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell><Badge variant="red">Complaints</Badge></Table.Cell>
      <Table.Cell>Maintenance requests and issue reporting</Table.Cell>
      <Table.Cell>Ticket creation, tracking, resolution</Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell><Badge variant="green">Payments</Badge></Table.Cell>
      <Table.Cell>Billing, payments, and financial services</Table.Cell>
      <Table.Cell>Invoicing, payment processing, history</Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell><Badge variant="purple">Facilities</Badge></Table.Cell>
      <Table.Cell>Amenity booking and facility management</Table.Cell>
      <Table.Cell>Booking, availability, scheduling</Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell><Badge variant="orange">Routines</Badge></Table.Cell>
      <Table.Cell>Automation and scheduled tasks</Table.Cell>
      <Table.Cell>Automation, scheduling, triggers</Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell><Badge variant="indigo">Email</Badge></Table.Cell>
      <Table.Cell>Communication and notification services</Table.Cell>
      <Table.Cell>Templates, delivery, tracking</Table.Cell>
    </Table.Row>
  </Table.Body>
</Table>
...
The Services Platform provides comprehensive property developer integration:

- **Custom Integrations**: Property-specific service integrations and workflows
- **Data Synchronization**: Real-time data sync with property management systems
- **Configuration Management**: Property-specific settings and preferences
- **Multi-Property Support**: Support for multiple property developments and portfolios
...
Check the health status of the Services Platform and verify connectivity with all third-party services.
